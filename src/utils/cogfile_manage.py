...
#                                                                                              #
# On this file, any line on this file that starts with '#' will be ignored                     #
# If you add comments here, please, respect this template so you dont break our readers!       #
# Dont leave empty lines here too! It will break our readers sadly. Use # instead to space     #
#                                                                                              #
# Failing to do so will probably mess up the cog loading/reloading/unloading functions ):      #
################################################################################################
#
# cog_example
''')
